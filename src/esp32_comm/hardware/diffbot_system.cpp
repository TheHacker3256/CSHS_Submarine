...
#include "esp32_comm/diffbot_system.hpp"
...
hardware_interface::return_type esp32_comm ::DiffDriveArduinoHardware::write(
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  if (!comms_.connected())
  {
...
PLUGINLIB_EXPORT_CLASS(
  esp32_comm::DiffDriveArduinoHardware, hardware_interface::SystemInterface)
