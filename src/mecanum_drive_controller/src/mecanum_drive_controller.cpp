  ...
  const rclcpp::Time & time, const rclcpp::Duration & period)
{
    ...
    !std::isnan(reference_interfaces_[2]))
  {
    ...
    double wheel_front_left_vel = reference_interfaces_[0] - reference_interfaces_[1] - reference_interfaces_[2];
    double wheel_front_right_vel = reference_interfaces_[0] + reference_interfaces_[1] - reference_interfaces_[2];
    double wheel_rear_right_vel = reference_interfaces_[0] - reference_interfaces_[1] + reference_interfaces_[2];
    double wheel_rear_left_vel = -reference_interfaces_[0] - reference_interfaces_[1] - reference_interfaces_[2];

    // if(wheel_front_left_vel > 1) {wheel_front_left_vel = 1;} // limit wheel_front_left_vel to 1
    // if(wheel_front_left_vel < -1) {wheel_front_left_vel = -1;} // limit wheel_front_left_vel to -1
    // if(wheel_front_right_vel > 1) {wheel_front_right_vel = 1;} // limit wheel_front_right_vel to 1
    // if(wheel_front_right_vel < -1) {wheel_front_right_vel = -1;} // limit wheel_front_right_vel to -1
    // if(wheel_rear_right_vel > 1) {wheel_rear_right_vel = 1;} // limit wheel_rear_right_vel to 1
    // if(wheel_rear_right_vel < -1) {wheel_rear_right_vel = -1;} // limit wheel_rear_right_vel to -1
    // if(wheel_rear_left_vel > 1) {wheel_rear_left_vel = 1;} // limit wheel_rear_left_vel to 1
    // if(wheel_rear_left_vel < -1) {wheel_rear_left_vel = -1;} // limit wheel_rear_left_vel to -1
